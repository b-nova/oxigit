...
use pages::{
    ...
    conflict_resolve::ConflictResolvePage, contact::ContactPage, explore::ExplorePage,
    home::HomePage, issue_list::IssueListPage, issue_new::IssueNewPage, issue_view::IssueViewPage,
    login::LoginPage, org_new::OrgNewPage, org_settings::OrgSettingsPage, pr_list::PrListPage,
    pr_new::PrNewPage, pr_view::PrViewPage, pricing::PricingPage, profile_edit::ProfileEditPage,
    prompt_detail::PromptDetailPage, prompt_history::PromptHistoryPage,
    recipe_detail::RecipeDetailPage, recipe_marketplace::RecipeMarketplacePage,
    recipe_share::ShareRecipePage, register::RegisterPage, remix_guide::RemixGuidePage,
    repo_blob::RepoBlobPage, repo_list::RepoListPage, repo_metrics::RepoMetricsPage,
    repo_new::NewRepoPage, repo_settings::RepoSettingsPage, repo_view::RepoViewPage,
    settings::SettingsPage, user_profile::UserProfilePage,
};
